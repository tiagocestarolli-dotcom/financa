# PROMPT-MESTRE — Projeto Finança · v18
...
## ✅ STATUS ATUAL — Fatia 5c.1 ENTREGUE (filtros no Detalhe + lista detalhada nos PDFs) · v0.25.0
...
### ⏳ Etapa 5c — Relatório Detalhado (5c ✅ + 5c.1 ✅ entregues; 5c.2 pendente)
...
- **Fatia 5c.2 ⏳ Append de fluxo no Rel 2** — o Rel 2 é regime de caixa e inclui ENTRADAS (sem categoria/membro) + cache de faturas pagas; não cabe no renderer de gastos do apêndice atual. Precisa de um renderer próprio de "extrato de fluxo" (entradas verde / saídas terracota / invest navy, em ordem de data). O total do apêndice deve reconciliar com o hero3 do Rel 2 (Entradas/Saídas/Invest). Isolada da 5c.1 de propósito (estrutura diferente, relatório mais delicado).

### ⏳ Etapa 5b — Importação de extrato bancário (gap-filler) — Itaú ✅, Sicoob/BTG pendentes
...
**Estado:** pipeline + parser **Itaú** entregues (v0.23.x) com undo em lote, dedup em 3 níveis, modo rascunho e classificação inline. Pendentes: **5b.3 parser de extrato Sicoob** e **5b.4 parser de extrato BTG**.
...
**Pré-requisito de 5b.3/5b.4:** 1 extrato de **conta corrente** real de cada banco (Sicoob, BTG). Atenção: os PDFs Sicoob/BTG no projeto são **faturas de cartão** (já têm parser próprio na Fatia 3.x) — extrato de conta é layout diferente.
