# PROMPT-MESTRE — Projeto Finança · v17
...
## ✅ STATUS ATUAL — Etapa 5b (Importação de extrato — Itaú) + Fatia 5c (Relatório Detalhado) ENTREGUES · ainda dentro da v0.24.x

**Última versão entregue:** `v0.24.0 · Fatia 5c — relatório detalhado por escopo` (rodapé do Config).

**Sessão de 19–20/maio/2026 — Etapa 5b (importação de extrato Itaú) + Fatia 5c (Relatório Detalhado) — 4 versões em sequência (v0.23.0 → v0.24.0):**
